...
static const ClockConfiguration clockConfigs[] =
{
    ...
    {200.50, 8000000, 8, 401, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.580357, 0.000227},
    {200.57, 8000000, 7, 351, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.581633, 0.000583},
    {200.67, 8000000, 6, 301, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.583333, 0.001058},
    {200.80, 8000000, 5, 251, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.585714, 0.001723},
    {200.00, 8000000, 7, 350, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.571429, -0.002267},
    {200.00, 8000000, 4, 200, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.571429, -0.002267},
    {200.00, 8000000, 5, 250, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.571429, -0.002267},
    {200.00, 8000000, 6, 300, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.571429, -0.002267},
    {200.00, 8000000, 8, 400, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.571429, -0.002267},
    {201.00, 8000000, 4, 201, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.589286, 0.002721},
    {201.00, 8000000, 8, 402, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.589286, 0.002721},
    {201.14, 8000000, 7, 352, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.591837, 0.003434},
    {201.33, 8000000, 6, 302, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.595238, 0.004384},
    {199.50, 8000000, 8, 399, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.562500, -0.004762},
    {199.43, 8000000, 7, 349, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.561224, -0.005118},
    {201.50, 8000000, 8, 403, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.598214, 0.005216},
    {199.33, 8000000, 6, 299, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.559524, -0.005593},
    {201.60, 8000000, 5, 252, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.600000, 0.005714},
    {199.20, 8000000, 5, 249, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.557143, -0.006258},
    {201.71, 8000000, 7, 353, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.602041, 0.006285},
    {199.00, 8000000, 4, 199, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.553571, -0.007256},
    {199.00, 8000000, 8, 398, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.553571, -0.007256},
    {202.00, 8000000, 4, 202, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.607143, 0.007710},
    {202.00, 8000000, 6, 303, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.607143, 0.007710},
    {202.00, 8000000, 8, 404, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.607143, 0.007710},
    {198.86, 8000000, 7, 348, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.551020, -0.007969},
    {198.67, 8000000, 6, 298, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.547619, -0.008919},
    {202.29, 8000000, 7, 354, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.612245, 0.009135},
    {202.40, 8000000, 5, 253, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.614286, 0.009705},
    {198.50, 8000000, 8, 397, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.544643, -0.009750},
    {202.50, 8000000, 8, 405, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.616071, 0.010204},
    {198.40, 8000000, 5, 248, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.542857, -0.010249},
    {198.29, 8000000, 7, 347, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.540816, -0.010819},
    {202.67, 8000000, 6, 304, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.619048, 0.011036},
    {202.86, 8000000, 7, 355, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.622449, 0.011986},
    {198.00, 8000000, 4, 198, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.535714, -0.012245},
    {198.00, 8000000, 6, 297, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.535714, -0.012245},
    {198.00, 8000000, 8, 396, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.535714, -0.012245},
    {203.00, 8000000, 4, 203, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.625000, 0.012699},
    {203.00, 8000000, 8, 406, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.625000, 0.012699},
    {197.71, 8000000, 7, 346, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.530612, -0.013670},
    {203.20, 8000000, 5, 254, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.628571, 0.013696},
    {197.60, 8000000, 5, 247, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.528571, -0.014240},
    {203.33, 8000000, 6, 305, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.630952, 0.014361},
    {197.50, 8000000, 8, 395, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.526786, -0.014739},
    {203.43, 8000000, 7, 356, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.632653, 0.014837},
    {203.50, 8000000, 8, 407, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.633929, 0.015193},
    {197.33, 8000000, 6, 296, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.523810, -0.015571},
    {197.14, 8000000, 7, 345, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.520408, -0.016521},
    {197.00, 8000000, 4, 197, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.517857, -0.017233},
    {197.00, 8000000, 8, 394, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.517857, -0.017233},
    {204.00, 8000000, 4, 204, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.642857, 0.017687},
    {204.00, 8000000, 5, 255, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.642857, 0.017687},
    {204.00, 8000000, 6, 306, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.642857, 0.017687},
    {204.00, 8000000, 8, 408, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.642857, 0.017687},
    {204.00, 8000000, 7, 357, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.642857, 0.017687},
    {196.80, 8000000, 5, 246, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.514286, -0.018231},
    {196.67, 8000000, 6, 295, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.511905, -0.018896},
    {196.57, 8000000, 7, 344, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.510204, -0.019371},
    {196.50, 8000000, 8, 393, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.508929, -0.019728},
    {204.50, 8000000, 8, 409, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.651786, 0.020182},
    {204.57, 8000000, 7, 358, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.653061, 0.020538},
    {204.67, 8000000, 6, 307, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.654762, 0.021013},
    {204.80, 8000000, 5, 256, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.657143, 0.021678},
    {196.00, 8000000, 7, 343, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.500000, -0.022222},
    {196.00, 8000000, 4, 196, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.500000, -0.022222},
    {196.00, 8000000, 5, 245, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.500000, -0.022222},
    {196.00, 8000000, 6, 294, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.500000, -0.022222},
    {196.00, 8000000, 8, 392, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.500000, -0.022222},
    {205.00, 8000000, 4, 205, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.660714, 0.022676},
    {205.00, 8000000, 8, 410, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.660714, 0.022676},
    {205.14, 8000000, 7, 359, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.663265, 0.023389},
    {205.33, 8000000, 6, 308, 2, 7, RCC_SYSCLK_DIV1, RCC_HCLK_DIV8, RCC_HCLK_DIV4, 3.666667, 0.024339},
};
